...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const searchButton = document.getElementById("searchAmplifierBtn");
  const searchInput = document.getElementById("searchAmplifier");
  ...
  async function fetchListProduct(page) {
    ...
    try {
      const res = await fetch(
        `${API_URL}/ampli/all?page=${page - 1}&size=${productsPerPage}`
      );
        ...
        const list = `
          ...
          product.model
            ...
            <td>
              <div>
                <a 
                href="https://tscproaudio.com/admin/edit/amplifier-edit/${
                  product.id
                }" 
  ...
  function deleteProduct() {
    ...
    deleteButtons.forEach((button) => {
      button.addEventListener("click", async function () {
        ...
        try {
          const response = await fetch(`${API_URL}/ampli/delete/${productId}`, {
            method: "DELETE",
            headers: {
  ...
  if (form) {
    form.addEventListener("submit", async function (event) {
      ...
      const data = {
        ...
        outputCircuitry: document.getElementById("outputCircuitry").value,
        ...
        protectPowerAmplifier: document.getElementById("protectPowerAmplifier")
          .value,
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (uploadForm) {
    uploadForm.addEventListener("submit", async function (event) {
      ...
      try {
        const response = await fetch(`https://tscproaudio.com/upload/ampli`, {
          method: "POST",
          headers: {
            Authorization: basicAuth,
          },
